...
INPUT_JSON_PATH = 'filtered_text_holod.json'  # Ваш исходный файл
OUTPUT_JSON_PATH = 'filtered_text_holod_labeled.json' # Файл, который получится на выходе
ILLUSTRATIONS_DIR = 'labeled_illustrations'
PHOTOS_DIR = 'labeled_photos'
