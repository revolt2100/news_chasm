...
# CONFIGURATION
# ==========================================
input_json_file = "holod_data_with_illustrations4.json" # Your master file
output_json_file = "final_holod_sentiment3.json" # New file so we don't overwrite the original if it crashes
